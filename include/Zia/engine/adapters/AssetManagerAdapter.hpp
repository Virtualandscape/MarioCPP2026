...
namespace zia::engine::adapters {
    ...
    public:
        explicit AssetManagerAdapter(std::shared_ptr<zia::AssetManager> a) : _assets(std::move(a)) {}
        ...
        [[nodiscard]] std::shared_ptr<zia::AssetManager> underlying() const { return _assets; }

    private:
        std::shared_ptr<zia::AssetManager> _assets;
    };
} // namespace Zia::engine::adapters
