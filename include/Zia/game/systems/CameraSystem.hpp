...
namespace zia {
    ...
    public:
        ...
        void update(zia::engine::IEntityManager& registry, Camera& camera, float dt, float viewport_w, float viewport_h, EntityID target = 0);
        ...
        void initialize(zia::engine::IEntityManager& registry, Camera& camera, float viewport_w, float viewport_h, EntityID target = 0,
